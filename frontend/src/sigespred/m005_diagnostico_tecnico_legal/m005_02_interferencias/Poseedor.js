...
const Poseedor = ({propietario,editPropietarios,removeIntegrantes}) => {
    ...
    return (
        <>
            {edit ? <ModalEditPoseedor closeModal={setEdit} propietario={propietario} editPropietario={editar_propietario}/>: <div>
