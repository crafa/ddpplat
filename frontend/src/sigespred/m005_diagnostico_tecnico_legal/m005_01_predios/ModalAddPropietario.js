...
const ModalAddPropietario = ({closeModal, setIntegrantes, removeIntegrantes}) => {


    const [integrante, set_integrante] = useState({tipo_documento:'DNI'});
...
export default ModalAddPropietario;