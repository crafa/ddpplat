                ...
                <header className="navbar navbar-fixed-top bg-white">
                    <div className="container">
                        <div className="navbar-header">
                            ...
                            <Link to={`/solicitudes`} href="#" className="navbar-brand" title={"Sistema de Gestion de Predios"}>
                                <b> 
                                    <img src='/img/mapa.svg' height={'35'}></img>
                                    <span className="text-danger"> </span>  SIGESPRED  <span className="text-danger">MTC</span>
                                </b>
                        ...
                        <nav className="collapse navbar-collapse bs-navbar-collapse" role="navigation">
                            <ul className="nav navbar-nav navbar-right">
                                ...
                                <li className='menuprincipalsmall'>
                                    <center>  <Link to={`/cuadro-control`} className="top-link active">
