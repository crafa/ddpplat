...
class AgregarPredio extends Component {
    ...
    calculateNumebesPred=(e)=>{
       let numpred= e.target.value;
       
       console.log(numpred)
        let inicio='0001'
        let fin =String(numpred).padStart(4,"0000")
        this.setState({
            rangePred:inicio+' - '+fin
        })
    }
    
    render() {
        const {vial,aero,ferro,puerto,rangePred}=this.state;
        return (
            <div>
                ...
                <h4 className="headline ">
                    Registro de Solicitud de Expropiacion de Predios
                        ...
                        <div className="form-group">
                            ...
                            <div className="col-lg-3">
                                <input required className="form-control input-sm" type="text"
                                       placeholder="Ej. PM1G-AEROTM-PR-<NUM GENERADA>"></input>
                            </div>
                            <div className="col-lg-1 sin-marginform">
                              <label title={'Rango de numeracion generada'} className="control-label sin-marginform" >{rangePred}</label>
                            </div>
                            <label className="col-lg-2 control-label"><span className="obligatorio">* </span> Cant. Predios</label>
                            <div className="col-lg-1">
                                <input  required className="form-control input-sm" type="text"
                                       placeholder="Cant." onChange={this.calculateNumebesPred}></input>
                            </div>
                        </div>
