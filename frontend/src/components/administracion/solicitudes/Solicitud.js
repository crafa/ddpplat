...
const Solicitud = ({props}) => {
    console.log(props)
    const {id,fecha_registro,tipoinfraestructura,tipoproyecto,fechadocumento,createdAt,filesave,originalname,denominacion,organosolicitante}=props;
                        ...
                        <div>
                            <div className="col-md-1">
                                <div className="pull-left m-left-sm ">
                                    <span> <a target="_blank" href={`${serverFile}${filesave}`} style={{color:'#000'}} title={originalname}>
                            ...
                            <div className="col-md-7">
                                <div className="pull-left m-left-sm" style={{color:'#000'}}>
                                    ...
                                    <small style={{color:'#000'}} className="text-muted"><span style={{color:'red'}}>SOLICITADO POR:</span> {organosolicitante}   </small>
                                </div>
                            </div>
