                            ...
                            <div className="panel-heading">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h5>PROC-13 FORMULARIO REGISTRAL</h5>
                                    </div>
                            ...
                            <div className="panel-body">
                                ...
                                <form>
                                    <fieldset className={'fielsettext'}>
                                        <legend align="center fielsettext">Sujeto Activo MTC</legend>
                                    </fieldset>
                                </form>
                                <div>
                                    <div className="form-group">
                                        <label className="col-lg-12 control-label center-block"><span
                                            className="obligatorio"> </span> MINISTERIO DE TRANSPORTES Y COMUNICACIONES</label>
                                ...
                                <form>
                                    <fieldset className={'fielsettext'}>
                                        <legend align="center fielsettext">Beneficiario</legend>
                                    </fieldset>
                                </form>
                                <div>
                                    <div className="form-group">
                                ...
                                <div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Fecha Inscripcion</label>
                                        <div className="col-lg-2">
                                            <input required className="form-control input-sm" type="date" value={'jalar'}></input>
                                        </div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Representante</label>
                                        <div className="col-lg-2">
                                            <input required className="form-control input-sm" type="text" value={'jalar'}></input>
                                        </div>
                                        <label className="col-lg-1 control-label"><span
                                            className="obligatorio">* </span>DNI</label>
                                        <div className="col-lg-2">
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Poder</label>
