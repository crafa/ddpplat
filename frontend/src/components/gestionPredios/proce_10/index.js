                            ...
                            <div className="panel-heading">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h5>PROC-10 GESTIÓN DE CHEQUE</h5>
                                    </div>
                            ...
                            <div className="panel-body">
                                ...
                                <form>
                                    <fieldset className={'fielsettext'}>
                                        <legend align="center fielsettext">Memorando OGA</legend>
                                    </fieldset>
                                </form>
                                <div>
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Nº Memorando</label>
                                ...
                                <form>
                                    <fieldset className={'fielsettext'}>
                                        <legend align="center fielsettext">Comunicacion del Cheque</legend>
                                    </fieldset>
                                </form>
                                <div>
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Direccion de Correo enviada</label>
                                        <div className="col-lg-2">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span>Memorando</label>
                                        <div className="col-lg-2">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Nº</label>
                                        <div className="col-lg-2">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
                                        <label className="col-lg-2 control-label"><span
