                            ...
                            <div className="panel-heading">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h5>PROC-13 ACTA DE ENRTEGA DE CHEQUE</h5>
                                    </div>
                            ...
                            <div className="panel-body">
                                ...
                                <form>
                                    <fieldset className={'fielsettext'}>
                                        <legend align="center fielsettext">Datos</legend>
                                    </fieldset>
                                </form>
                                <div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Numero de Cheque</label>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Acta de Entrega</label>
                                        <div className="col-lg-4">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Notaria</label>
                                        <div className="col-lg-4">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
                                    ...
                                    <div className="form-group">
                                        <label className="col-lg-2 control-label"><span
                                            className="obligatorio">* </span> Dirección Notaria</label>
                                        <div className="col-lg-4">
                                            <input required className="form-control input-sm" type="text"></input>
                                        </div>
